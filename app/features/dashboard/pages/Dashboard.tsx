    ...
    <div className="w-full flex flex-col gap-10 mb-15">
      ...
      <div className="grid grid-cols-2 ml:grid-cols-3 gap-3 lg:gap-5">
        {dashboardData.map((item, index) => (
          <div
            key={index}
            className={`flex justify-between px-3 lg:px-4 py-3 rounded-[15px] w-full ${item.title === "Inactive Schools" ? "bg-[#E13838]" : "bg-white"} ${item.title === "Total New Schools" ? "items-start" : "items-center"}`}
          >
